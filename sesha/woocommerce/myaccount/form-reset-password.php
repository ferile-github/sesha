...
<form method="post" class="woocommerce-ResetPassword lost_reset_password / row align-items-end">
	...
	<div class="col-sm">
		...
		<p class="woocommerce-form-row form-row">
			...
			<button type="submit" class="woocommerce-Button button" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>">
